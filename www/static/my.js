...
function syncData_2(sl){	
			var school_id=$("#school_id").val();
			//alert(apipath+'rural_data_submit_2?&sl='+sl+'&school_id='+school_id+'&tempText='+encodeURIComponent(ruralData4));
			$.ajax({
					type: 'POST',
					url:apipath+'rural_data_submit_2?&sl='+sl+'&school_id='+school_id+'&tempText='+encodeURIComponent(ruralData4),
